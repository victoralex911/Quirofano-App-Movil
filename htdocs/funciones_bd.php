...
class funciones_BD {
    ...
    $result = mysql_query("INSERT INTO usuarios(username,password) VALUES('$username', '$password')");
	...
	$result=mysql_query("SELECT COUNT(*) FROM usuarios WHERE username='$user' AND password='$password' "); 
