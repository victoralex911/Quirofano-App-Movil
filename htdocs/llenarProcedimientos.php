...
<?php 
/*Programar procedimientos apartir del id de la cirugia programada (Procedimientos de vistas dinamicas)
...
$db = new funciones_BD();
	if($db->llenarProcedimientos($numRegistroInt, $largoProcedimientos, $arrayServicio, $arrayRegion, $arrayProcedimiento, $arrayDetalles)){
